...
func (ec *executionContext) _Query_stationByCD(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStation2ᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_stationByName(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Station)
	fc.Result = res
	return ec.marshalOStation2ᚕᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Station_beforeStation(ctx context.Context, field graphql.CollectedField, obj *model.Station) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Station)
	fc.Result = res
	return ec.marshalOStation2ᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNStation2sandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v model.Station) graphql.Marshaler {
	return ec._Station(ctx, sel, &v)
}

func (ec *executionContext) marshalNStation2ᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v *model.Station) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOStation2ᚕᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v []*model.Station) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOStation2ᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOStation2ᚖsandboxᚑgqlgenᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v *model.Station) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Station(ctx, sel, v)
